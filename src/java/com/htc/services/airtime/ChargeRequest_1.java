        ...
        if (chParam != null) {
            ...
            try {
                ...
                if (acc == null) {
                    ...
                    doAddErrChargeReq(request, chParam, result_mps, ERR_CODE.AUTHEN_FAIL.getJson());
                ...
                if (!cpCode.equals(chParam.getCpCode())) {
                    ...
                    doAddErrChargeReq(request, chParam, result_mps, ERR_CODE.CP_CODE_FAIL.getJson());
                ...
                if (!acc.validIP(ipAddress, ipAllow)) {
                    ...
                    doAddErrChargeReq(request, chParam, result_mps, ERR_CODE.IP_NOT_ALLOW.getJson());
                ...
                if (Tool.checkNull(chParam.getCpRequestId())) {
                    ...
                    doAddErrChargeReq(request, chParam, result_mps, ERR_CODE.REQUESTID_EMPTY.getJson());
                ...
                if (Tool.checkNull(chParam.getMsisdn())) {
                    ...
                    doAddErrChargeReq(request, chParam, result_mps, ERR_CODE.PHONE_NOTNULL.getJson());
                ...
                if (!PhoneValid.validPhoneViettel84(chParam.getMsisdn())) {
                    ...
                    doAddErrChargeReq(request, chParam, result_mps, ERR_CODE.PHONE_NOT_VALID.getJson());
                    return ERR_CODE.PHONE_NOT_VALID.getJson();
                    // Valid phone 
                }
                if (Tool.checkNull(chParam.getOtp())) {
                    System.out.println("GHI LOG FILE : TH getOtp null");
                    doAddErrChargeReq(request, chParam, result_mps, ERR_CODE.OTP_NOTNULL.getJson());
...
//                    result_mps = HttpRequest.sendPOST();
                    ...
                    if (result_mps.equals("-1")) {
                        ...
                        doAddErrChargeReq(request, chParam, result_mps, ERR_CODE.DISCONNECT_MPS.getJson());
