        ...
        if (chParam != null) {
            ...
            try {
                ...
                if (!cpCode.equals(chParam.getCpCode())) {
                    ...
                    doAddErrOtpReq(request, chParam, result_mps, ERR_CODE.CP_CODE_FAIL.getJson());
...
//                }
                ...
                if (Tool.checkNull(chParam.getMsisdn())) {
                    ...
                    doAddErrOtpReq(request, chParam, result_mps, ERR_CODE.PHONE_NOT_NULL.getJson());
                ...
                if (Tool.checkNull(chParam.getPrice())) {
                    System.out.println("GHI LOG FILE : TH getMsisdn null");
                    doAddErrOtpReq(request, chParam, result_mps, ERR_CODE.PRICE_NOT_NULL.getJson());
