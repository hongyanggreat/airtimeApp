...
//    private static final HashMap<String, ChargingParams> ReqCacheManager = new HashMap<>();
    static final Logger logger = Logger.getLogger(ChargeRequest.class);
        ...
        if (chParam != null) {
            ...
            try {
                ...
                if (acc == null) {
                    ...
                    doAddRequestCharge(request, chParam, result_mps, ERR_CODE.AUTHEN_FAIL.getJson());
                ...
                if (!cpCode.equals(chParam.getCpCode())) {
                    ...
                    doAddRequestCharge(request, chParam, result_mps, ERR_CODE.CP_CODE_FAIL.getJson());
                ...
                if (!acc.validIP(ipAddress, ipAllow)) {
                    ...
                    doAddRequestCharge(request, chParam, result_mps, ERR_CODE.IP_NOT_ALLOW.getJson());
                ...
                if (Tool.checkNull(chParam.getCpRequestId())) {
                    ...
                    doAddRequestCharge(request, chParam, result_mps, ERR_CODE.REQUESTID_EMPTY.getJson());
                ...
                if (Tool.checkNull(chParam.getMsisdn())) {
                    ...
                    doAddRequestCharge(request, chParam, result_mps, ERR_CODE.PHONE_NOTNULL.getJson());
                ...
                if (!PhoneValid.validPhoneViettel84(chParam.getMsisdn())) {
                    ...
                    doAddRequestCharge(request, chParam, result_mps, ERR_CODE.PHONE_NOT_VALID.getJson());
                    return ERR_CODE.PHONE_NOT_VALID.getJson();
                    // Valid phone 
                }
                if (Tool.checkNull(chParam.getOtp())) {
                    System.out.println("GHI LOG FILE : TH getOtp null");
                    doAddRequestCharge(request, chParam, result_mps, ERR_CODE.OTP_NOTNULL.getJson());
                ...
                if (chParamCache == null) {
                    ...
                    doAddRequestCharge(request, chParam, result_mps, ERR_CODE.CHARGE_NOT_VALID_OR_EXPRIRE.getJson());
                    ...
                    if (!cpRequestId.equals(cpRequestIdCache)) {
                        ...
                        doAddRequestCharge(request, chParamCache, result_mps, ERR_CODE.CP_REQ_NOT_VALID.getJson());
...
//                    result_mps = HttpRequest.sendPOST();
                    ...
                    if (result_mps.equals("-1")) {
                        ...
                        doAddRequestCharge(request, chParam, result_mps, ERR_CODE.DISCONNECT_MPS.getJson());
...
//                             XOA CACHE REQ_OTP NEU GOI DEN MPS CHARGE THANH CONG
                        ...
                        doAddRequestCharge(request, chParamCache, result_mps, ERR_CODE.SUCCESS_CHARGING.getJson());
                        ...
                        doAddRequestCharge(request, chParamCache, result_mps, mapErrorMps);
                        return mapErrorMps;
                    }
                }
...
//        return result;
    ...
    public static boolean doAddRequestCharge(String request, ChargingParams chParam, String rs_mps, String rs_ahp) {
        boolean rs = false;
        ...
        rs = airTimeRequest.addRequestCharge(airTimeRequest);
